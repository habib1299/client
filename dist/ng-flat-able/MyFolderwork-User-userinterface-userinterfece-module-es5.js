...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["MyFolderwork-User-userinterface-userinterfece-module"], {
  ...
  function srcAppMyFolderworkUserUserinterfaceUserinterfaceRoutingModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    UserinterfaceRoutingModule.ɵmod = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineNgModule"]({
      type: UserinterfaceRoutingModule
    });
    UserinterfaceRoutingModule.ɵinj = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineInjector"]({
    ...
    (function () {
      (typeof ngJitMode === "undefined" || ngJitMode) && _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵsetNgModuleScope"](UserinterfaceRoutingModule, {
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserinterfaceRoutingModule, [{
  ...
  function srcAppMyFolderworkUserUserinterfaceUserinterfaceComponentTs(module, __webpack_exports__, __webpack_require__) {
        ...
        value: function onSubmit(paymentForm) {
          ...
          this.http.get(this.URL + 'Appartement' + '/' + this.appartementID).toPromise().then(function (data) {
            if (paymentForm.value.appartementFacturePrix != JSON.parse(data.appartementFacturePrix)) {
              _this.ErrorMessage = "المبلغ  غير صحيح";
    ...
    UserinterfaceComponent.ɵfac = function UserinterfaceComponent_Factory(t) {
    ...
    UserinterfaceComponent.ɵcmp = _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵdefineComponent"]({
      ...
      template: function UserinterfaceComponent_Template(rf, ctx) {
        if (rf & 1) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserinterfaceComponent_Template_button_click_31_listener($event) {
          ...
          _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵɵlistener"]("click", function UserinterfaceComponent_Template_button_click_35_listener($event) {
            return ctx.logout();
          });
    ...
    (function () {
      _angular_core__WEBPACK_IMPORTED_MODULE_0__["ɵsetClassMetadata"](UserinterfaceComponent, [{
